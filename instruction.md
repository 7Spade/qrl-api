...
gcloud scheduler jobs create http rebalance-50-50 \
  --schedule="0 */1 * * *" \
  --time-zone="Asia/Taipei" \
  --http-method=POST \
  --uri="https://qrl-trading-api-545492969490.asia-southeast1.run.app/tasks/rebalance/50-50" \
  --oidc-service-account-email="qrl-api@appspot.gserviceaccount.com" \
  --oidc-token-audience="https://qrl-trading-api-545492969490.asia-southeast1.run.app" \
  --message-body='{"job":"REBALANCE_50_50"}'
