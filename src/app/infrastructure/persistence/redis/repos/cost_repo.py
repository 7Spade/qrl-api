...
class CostRepository:
    ...
    async def calculate_pnl(
        ...
        return summarize_cost_data(
            cost_data, current_price, current_quantity
        )
    ...
    async def update_after_buy(
        ...
        try:
            values = update_after_buy_values(
                cost_data, buy_price, buy_amount_usdt
            )
            return await self.set_cost_data(
    ...
    async def update_after_sell(
        ...
        try:
            ...
            logger.error(
                f"Failed to update cost after sell: {exc}"
            )
            return False
