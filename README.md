...
gcloud run deploy qrl-trading-api --image asia-southeast1-docker.pkg.dev/qrl-api/qrl-trading-api/qrl-trading-api:latest --region asia-southeast1 --platform managed --allow-unauthenticated
